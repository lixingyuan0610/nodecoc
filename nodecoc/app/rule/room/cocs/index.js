...
async function startNewsList(CategoriesItem, page = 0) {
  ...
  if (setupDatas.clan) {
   ...
   /*    if (item.fame > 4000 && item.fame < 5000) {
    ...
    console.log('<tr><td>#' + CategoriesItem.keys + '</td><td>' + CategoriesItem.name.split('#')[0] + '</td><td>' + num00 + '</td><td>' + num0 + '</td><td>' + num1 + '</td><td>' + num2 + '</td><td>' + num3 + '</td><td>' + num4 + '</td><td>' + num5 + '</td></tr>')
  }
